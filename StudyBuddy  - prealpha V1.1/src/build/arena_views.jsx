/* ==========================================================================
 * arena_views.jsx · Arena hub + every Arena UI screen + tabbed wrappers
 *
 * Splice position: STRICTLY LAST in the splice order — it references every
 *                  other helper (combat.jsx, raids.jsx, cram.jsx, all the
 *                  registries from arena_runtime.jsx and bonuses.jsx).
 * Defines:  ArenaView (the hub — 5-button toolbar, World stages inline),
 *           ArmoryView, SkillTreeView, HotbarView, LibrarianView (with
 *           BestiarySection inside), PetSanctuaryView, ForgeView,
 *           PassivesView, ExchangeView, BestiarySection,
 *           **LoadoutView** (5-tab wrapper: Armory · Tree · Hotbar · Pets ·
 *           Passives), **WorkshopView** (3-tab wrapper: Forge · Librarian
 *           · Exchange).
 * Reads:    Everything from upstream: ABILITIES, WEAPONS,
 *           getWeaponProgress, weaponXpNeeded, weaponAbilityIds,
 *           availableSP, totalSP, LOOT_TABLE, PET_REGISTRY, PRESTIGE_RANKS,
 *           PRESTIGE_PERKS, getCombinedStats, getStatBuffs, statBuffProgress,
 *           STAT_BUFF_TIERS, FORGE_*, EXCHANGE_OFFERS, ENEMY_ABILITIES,
 *           ENEMY_PASSIVES, RAID_DEFS, CombatScreen, ResultScreen,
 *           CramHub, RaidHubView, RaidView, WorldView, getAbilityDesc,
 *           moduleSkill, levelFromXp.
 *
 * Hub layout (post-consolidation, 2026-05-09):
 *   BUILD: Loadout · Workshop
 *   PLAY:  Blitz · Raids
 *   World stages render inline below the toolbar.
 *   Old phase strings (armory/tree/hotbar/pets/passives/forge/librarian/
 *   exchange) auto-redirect into LoadoutView/WorkshopView with the matching
 *   tab pre-selected — keeps any legacy setPhase('armory') calls working.
 *
 * Edit when: restructuring the Arena hub, adding a new tab to Loadout or
 * Workshop, or tweaking how a *View component renders.
 * ========================================================================== */
/* ============ ARENA ROOT ============ */
