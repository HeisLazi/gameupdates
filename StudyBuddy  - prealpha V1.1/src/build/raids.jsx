/* ==========================================================================
 * raids.jsx · 4-phase boss-chain raids
 *
 * Splice position: after arena_runtime.jsx, before combat.jsx (RaidView
 *                  wraps CombatScreen — function declarations are hoisted
 *                  so the JSX reference resolves at render time).
 * Defines:  RAID_PHASES, RAID_PHASE_META, RAID_DEFS (3 raids:
 *           logic_singularity, malware_hive, corrupted_professor),
 *           defaultRaidProgress, buildRaidBoss, RaidHubView, RaidView.
 * Reads:    LOOT_TABLE, RAID_TYPES, RELIC_MAP, dropLoot (arena_runtime.jsx).
 *
 * Structure: each raid is a chain of 4 CombatScreens, one per phase
 * (Setup → Pressure → Burn → Death). Full clear awards relic + bonus mythic.
 *
 * Edit when: adding a new raid, tuning per-phase difficulty (hpMul, dmgMul,
 * dotPerTurn, addCount), or changing the relic / bonus reward logic.
 * ========================================================================== */
