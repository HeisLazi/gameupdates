/* ==========================================================================
 * world.jsx · Per-module World hub (Dojo · Practice · Street · Elite · Boss)
 *
 * Splice position: after extras.jsx, before bonuses.jsx.
 * Defines:  ELITE_MASTERY_THRESHOLD, masteryOfLevel, eliteUnlocked,
 *           bossUnlocked, BIOME_EMOJI_PALETTES, biomePalette, genWorld,
 *           WorldView, InsightsPanel, PracticeSelect.
 * Reads:    levelFromXp (app.jsx), getBiome (arena_runtime.jsx — runtime ok
 *           because WorldView is rendered after the full splice).
 *
 * Edit when: changing the World stage layout, mastery gating for Elite/Boss,
 * the per-biome emoji palette, or the in-combat InsightsPanel.
 * ========================================================================== */
