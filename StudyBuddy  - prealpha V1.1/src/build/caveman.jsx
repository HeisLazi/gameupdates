/* ==========================================================================
 * caveman.jsx · 7th weapon (Primal / Berserker) — extends skills.jsx in place
 *
 * Splice position: STRICTLY after skills.jsx and before enemies.jsx. This file
 *                  monkey-patches ABILITIES, WEAPONS, WEAPON_MASTERY_BONUSES,
 *                  and getCombinedStats. If spliced earlier, those globals
 *                  don't exist yet and the build dies silently.
 * Defines:  No new top-level constants. Mutates pre-existing globals only.
 *           Adds abilities: club_bonk, gnaw, war_cry, rampage. Adds weapon:
 *           caveman. Adds mastery bonuses for caveman at lvls 3/5/7/10.
 *           Wraps getCombinedStats once.
 * Reads:    ABILITIES, WEAPONS, WEAPON_MASTERY_BONUSES, getCombinedStats
 *           (all from skills.jsx).
 *
 * Why it matters: Rampage (advanced) is the ONLY weapon ability with
 * `hitsAll: true` — direct synergy with multi-mob combat and Blitz waves.
 *
 * Edit when: balancing the caveman archetype, adding a new mastery bonus,
 * or adding another monkey-patched ability.
 * ========================================================================== */
