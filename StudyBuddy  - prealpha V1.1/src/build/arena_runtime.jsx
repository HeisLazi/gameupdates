/* ==========================================================================
 * arena_runtime.jsx · The Arena's grab-bag: rewards · forge · bestiary ·
 *                     exchange · loot · biomes · raids registry · lore ·
 *                     weapon helpers · arenaQuestions
 *
 * Splice position: after study_pass.jsx, before raids.jsx (raids reads
 *                  LOOT_TABLE, RAID_TYPES, RELIC_MAP, dropLoot from here).
 * Defines:  REWARD_POOL, getRewardBonuses, rollRewardChoices, two
 *           getCombinedStats wrappers (rewards layer + lifetime-stats layer
 *           on top of skills.jsx + caveman.jsx); FORGE_SHARD_VALUE,
 *           FORGE_CRAFT_COST, FORGE_UPGRADE_COST, FORGE_UPGRADE_MAX,
 *           forgeUpgradeCost, forgeShardAugment, forgeCraftAugment,
 *           forgeUpgradeAugment; bestiaryKey, recordBestiaryEncounter,
 *           recordBestiaryMistake; EXCHANGE_OFFERS, applyExchangeOffer;
 *           weaponList, getWeaponDef, weaponAbilityIds; LOOT_TABLE
 *           (~35 augments), LOOT_TIERS, dropLoot, addDropsToInventory,
 *           getSocket; BIOMES (16), getBiome, biomeModifierChips;
 *           RAID_TYPES, RELIC_MAP, LORE_DATA, LORE_IDS, FORGE_RECIPES;
 *           initArena, getWeaponProgress, weaponXpNeeded, gainWeaponXp,
 *           totalSP, availableSP, moduleSkill, genBosses, arenaQuestions,
 *           getAbilityDesc.
 * Reads:    getCombinedStats (skills.jsx + caveman.jsx wraps), getStatBuffs
 *           (bonuses.jsx), shuffle (app.jsx), WEAPONS (skills.jsx + caveman.jsx).
 *
 * **HEAVY FILE WARNING**: this is the largest non-UI file. Splitting it is
 * tempting but risky — many downstream files reference these globals. Keep
 * grouped here until a planned refactor.
 *
 * Edit when: adding a new augment / biome / raid type, adjusting Forge or
 * Forbidden Exchange economy, changing how level-up rewards roll, or
 * tuning bestiary record-keeping.
 * ========================================================================== */
/* ============ ARENA RUNTIME GLUE ============ *
...
const LOOT_TABLE = {
  ...
  // (removed duplicate `scholar_eye` key on 2026-05-09 — was identical to scholars_eye.
  //  bonuses.jsx AUGMENT_EFFECTS still has a separate scholars_eye entry with a
  //  DIFFERENT effect (revealEnemyHp). That mismatch is a balance bug to resolve
  //  separately — pick one effect and unify.)
