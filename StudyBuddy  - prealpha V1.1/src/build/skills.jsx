/* ==========================================================================
 * skills.jsx · Ability tiers · Weapon registry · Skill tree · getCombinedStats
 *
 * Splice position: after bonuses.jsx, before caveman.jsx (caveman extends
 *                  ABILITIES + WEAPONS + monkey-patches getCombinedStats).
 * Defines:  TIER, ABILITIES (weapon + tree), WEAPONS (6 base — caveman adds
 *           the 7th), WEAPON_MASTERY_BONUSES, TREE_ABILITIES, getCombinedStats.
 * Reads:    getAugmentBonuses (bonuses.jsx).
 *
 * Edit when: balancing weapons or tree nodes, adding a new ability, or
 * touching the getCombinedStats aggregation (DOWNSTREAM caveman.jsx and
 * arena_runtime.jsx ALSO wrap this function — keep wrap order: skills → caveman
 * → arena_runtime rewards layer → arena_runtime stat-buffs layer).
 * ========================================================================== */
